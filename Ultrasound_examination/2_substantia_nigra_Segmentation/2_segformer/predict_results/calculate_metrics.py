...
if __name__ == "__main__":
    pred_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/2_segformer/predict_results/predicts/fold_4"
    ...
    output_file = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/2_segformer/predict_results/test_metrics/fold4/metrics.txt"
