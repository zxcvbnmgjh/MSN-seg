...
# -------------------------------
# 模型权重路径
WEIGHTS_PATH = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/3_transunet/save_weights/5fold/fold_0/best_model.pth"

# 输入图像文件夹（所有图像必须是 512x512）
INPUT_FOLDER = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/test/fold0/images"

# 输出预测结果文件夹
OUTPUT_FOLDER = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/3_transunet/predict_results/test/fold0"
