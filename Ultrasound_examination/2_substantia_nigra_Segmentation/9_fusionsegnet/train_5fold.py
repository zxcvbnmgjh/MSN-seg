...
class SegmentationPresetEval:
    def __init__(self, crop_size, mean=(0.2767337, 0.27674654, 0.27666409), std=(0.25553482, 0.25551227, 0.25543953)
                 ):
...
def get_k_fold_indices(dataset_size, k=5):
    ...
    if dataset_size < 370:
        raise ValueError(f"数据集大小 ({dataset_size}) 小于所需的最大索引 (370)。")
...
def main(args, fold_idx, all_indices, full_dataset):
    ...
    # num_workers = 0  # 设置为 0 避免多进程导致的段错误
