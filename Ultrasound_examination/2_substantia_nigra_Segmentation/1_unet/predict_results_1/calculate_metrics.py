...
if __name__ == "__main__":
    pred_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/predict_results_1/predicts/iteration1"
    label_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/full/splits_1/fold0/masks"
    output_file = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/predict_results_1/metrics.txt"
