...
def main():
    ...
    parser.add_argument("--test-names-file", type=str, 
                        ...
                        default="/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/5fold_save_result_1/fold_indices/fold_4_test.txt")
    parser.add_argument("--weights", type=str,
                        help="Path to SINGLE model checkpoint (.pth)",
                        default="/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/save_weights_1/5fold/fold_4/best_model.pth")
    parser.add_argument("--device", type=str, default="cuda:0", help="Device")
    parser.add_argument("--pred-save-dir", type=str, 
                        help="Where to save predicted masks",
                        default="/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/predict_results_1/predicts/iteration5")
    ...
    parser.add_argument("--metrics-output", type=str, 
                        ...
                        default="/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/predict_results_1/test_metrics/iteration5")
