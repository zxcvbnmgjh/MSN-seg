...
def main():
    ...
    weights_path = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/save_weights/5fold/fold_4/best_model.pth"   # 最优权重地址
    input_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/test/fold4/images"  # 输入文件夹路径
    output_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/1_unet/predict_results/test/fold4"  # 输出文件夹路径
