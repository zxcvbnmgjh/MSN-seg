...
if __name__ == "__main__":
    pred_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/4_deeplabv3/predict_results/predicts/fold_4"
    label_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/Test(512*512)groundtruth/fold4/masks"
    output_file = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/4_deeplabv3/predict_results/test_metrics/fold4/metrics.txt"
