...
def main():
    ...
    # 模型权重路径
    weights_path = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/4_deeplabv3/save_weights/5fold/fold_4/best_model.pth"
    
    # 输入图像文件夹路径
    input_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/test/fold4/images"
    
    # 输出分割结果文件夹路径
    output_folder = "/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/4_deeplabv3/predict_results/test/fold4"
