...
def main():
    ...
    parser.add_argument("--image_dir", type=str, default="/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/images", help="原图文件夹路径")
    parser.add_argument("--mask_dir", type=str, default="/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/masks", help="掩码文件夹路径")
