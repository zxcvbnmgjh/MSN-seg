...
if __name__ == "__main__":
    folder_path = r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/images"          # 替换为你的实际文件夹路径
    output_path = r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/letter_prefixes.txt"     # 替换为输出文件路径
