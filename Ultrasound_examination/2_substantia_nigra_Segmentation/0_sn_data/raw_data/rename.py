...
def rename_png_files_by_order(source_folder, target_folder, prefix="substantia-nigra", suffix="_mask"):
    """
    将源文件夹中所有 PNG 文件按排序顺序重命名为：
        {prefix}XXX{suffix}.png
    例如：midbrain001_mask.png, midbrain002_mask.png ...
...
if __name__ == "__main__":
    # ⚠️ 请替换为你的实际路径
    SOURCE_DIR = r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/masks000"
    TARGET_DIR = r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/full/masks"
