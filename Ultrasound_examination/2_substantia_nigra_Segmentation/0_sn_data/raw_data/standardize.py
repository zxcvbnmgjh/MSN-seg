...
# ========== 1) 路径设置（改这里） ==========
IMG_DIR_IN  = Path(r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/images")   # 仅放 *_image.png
MSK_DIR_IN  = Path(r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/masks")    # 仅放 *_mask.png
OUT_IMG_DIR = Path(r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/standardize_output/images_norm")
OUT_MSK_DIR = Path(r"/data2/gaojiahao/Ultrasound_examination/2_substantia_nigra_Segmentation/0_sn_data/raw_data/standardize_output/labels")
