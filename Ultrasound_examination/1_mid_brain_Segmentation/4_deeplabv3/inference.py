...
def main():
    ...
    parser.add_argument("--test-names-file", type=str,
                        ...
                        default="/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/4_deeplabv3/5fold_save_result/fold_indices/fold_4_test.txt")
    parser.add_argument("--weights", type=str,
                        help="Path to SegFormer model checkpoint (.pth)",
                        default="/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/4_deeplabv3/save_weights/5fold/fold_4/best_model.pth")
    ...
    parser.add_argument("--pred-save-dir", type=str, 
                        ...
                        default="/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/4_deeplabv3/predict_results/predicts/iteration5")
    parser.add_argument("--metrics-output", type=str,
                        help="Path to save metrics report (e.g., ./metrics.txt)",
                        default="/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/4_deeplabv3/predict_results/test_metrics/iteration5")
