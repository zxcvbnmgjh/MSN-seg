...
if __name__ == "__main__":
    # ⚠️ 请替换为你的实际路径
    SOURCE_DIR = r"/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/0_midbrain_data/raw_data/masks"
    TARGET_DIR = r"/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/0_midbrain_data/raw_data/masks000"
