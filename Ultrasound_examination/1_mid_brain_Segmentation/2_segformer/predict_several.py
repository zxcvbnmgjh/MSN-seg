...
def main():
    ...
    weights_path = "/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/2_segformer/save_weights/5fold/fold_1/best_model.pth"
    input_folder = "/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/0_midbrain_data/Test(512*512)groundtruth/fold2/images"  # 输入文件夹路径
    output_folder = "/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/2_segformer/predict_results/predicts/fold1" # 输出文件夹路径
    ...
    with torch.no_grad():
        for img_name in image_files:
            ...
            try:
                ...
                output_name = f"{base_name}_predict{ext}"  # 添加 _mask 后缀
