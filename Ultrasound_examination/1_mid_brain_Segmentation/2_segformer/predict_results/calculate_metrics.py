...
if __name__ == "__main__":
    pred_folder = "//data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/2_segformer/predict_results/predicts/fold_4"
    label_folder = "/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/0_midbrain_data/Test(512*512)groundtruth/fold5/masks"
    output_file = "/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/2_segformer/predict_results/test_metrics/fold5"
