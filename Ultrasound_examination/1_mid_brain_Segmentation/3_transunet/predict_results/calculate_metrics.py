...
if __name__ == "__main__":
    pred_folder = "/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/3_transunet/predict_results/predicts/fold_4"
    ...
    output_file = "/data2/gaojiahao/Ultrasound_examination/1_mid_brain_Segmentation/3_transunet/predict_results/test_metrics/fold5"
