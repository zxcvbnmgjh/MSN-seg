...
# ---------------------------
FOLDER1_IMAGES = "/data2/gaojiahao/paper_prepare/qualitative_comparison_table/substantia-nigra/data_2/input"   # 文件夹1：前缀_image.png
FOLDER2_GT        = "/data2/gaojiahao/paper_prepare/qualitative_comparison_table/substantia-nigra/data_2/gt"       # 文件夹2：前缀_mask_A.png（真值）
FOLDER3_PRED      = "/data2/gaojiahao/paper_prepare/qualitative_comparison_table/substantia-nigra/data_1/unet"     # 文件夹3：前缀_mask_B.png（预测）
FOLDER4_OUT       = "/data2/gaojiahao/paper_prepare/qualitative_comparison_table/substantia-nigra/data_2/unet"      # 文件夹4：输出前缀_label_comparision.png

IMG_SUFFIX  = "_input.png"
GT_SUFFIX   = "_gt.png"
PRED_SUFFIX = "_unet.png"
OUT_SUFFIX  = "_unet.png"
