...
# 参数设置
# ===========================
image_dir = "/data2/gaojiahao/paper_prepare/qualitative_comparison_table/midbrian/data"
...
fig.suptitle("Midbrain Segmentation Results Comparison", fontsize=21, fontweight='bold')
...
# 保存图片
output_path = "segmentation_comparison_roi_view.png"
