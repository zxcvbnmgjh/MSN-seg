...
# 参数设置
# ===========================
image_dir = "/data2/gaojiahao/paper_prepare/qualitative_comparison_table/midbrian/data"  # 替换为你的图像路径
...
fig.suptitle(" Midbrain Segmentation Results Comparison", fontsize=18, fontweight='bold')
