...
if __name__ == "__main__":
    pred_folder = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/midbrain/diff_labels_v1"
    label_folder = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/midbrain/diff_labels_v2"
    output_file = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/midbrain/metrics.txt"
