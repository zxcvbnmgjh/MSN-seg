...
# 👇 设置路径（请替换为你自己的路径）
folder1_path = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/midbrain/stu_masks_old"      # 原始标签文件夹1
folder2_path = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/midbrain/stu_masks_new"      # 对比标签文件夹2
folder3_path = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/midbrain/diff_labels_v1" # 存放 folder1 中 Dice≠1 的文件
folder4_path = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/midbrain/diff_labels_v2" # 存放 folder2 中 Dice≠1 的文件
