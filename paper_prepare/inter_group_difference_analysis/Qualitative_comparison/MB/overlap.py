...
# ---------------------------
FOLDER1_IMAGES = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/Qualitative_comparison/MB/images"   # 文件夹1：前缀_image.png
FOLDER2_GT        = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/Qualitative_comparison/MB/masks_1"       # 文件夹2：前缀_mask_A.png（真值）
FOLDER3_PRED      = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/Qualitative_comparison/MB/masks_2"     # 文件夹3：前缀_mask_B.png（预测）
FOLDER4_OUT       = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/Qualitative_comparison/MB/overlaps"      # 文件夹4：输出前缀_label_comparision.png
...
# 颜色与样式（OpenCV 是 BGR）
# =========================
GT_COLOR   = (255, 255, 0)  # 黄色 Yellow
PRED_COLOR = (0, 255, 255)  # 青色 Cyan
