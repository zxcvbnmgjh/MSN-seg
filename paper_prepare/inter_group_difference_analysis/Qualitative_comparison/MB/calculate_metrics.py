...
if __name__ == "__main__":
    pred_folder = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/Qualitative_comparison/MB/masks_1"
    label_folder = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/Qualitative_comparison/MB/masks_2"
    output_file = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/Qualitative_comparison/MB/intergroup_differences/metrics.txt"
