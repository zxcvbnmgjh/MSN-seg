...
if __name__ == "__main__":
    # ========= 在此处指定两位标注者的标签文件夹 =========
    folder_a = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/substantia_nigra_new/mask_new"
    folder_b = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/substantia_nigra_new/mask_old"

    # 输出文件（或输出目录也行）
    output_file = "/data2/gaojiahao/paper_prepare/inter_group_difference_analysis/substantia_nigra_new/interobserver_metrics.txt"
