...
if __name__ == "__main__":
    # --- 请修改为你的实际路径 ---
    image_folder = '/data2/gaojiahao/MSN-TCSeg_dataset/1-10-new-draw/new_image' # 原图文件夹路径
    mask_folder = '/data2/gaojiahao/MSN-TCSeg_dataset/1-10-new-draw/png_mask'  # 掩码文件夹路径
    output_folder = '/data2/gaojiahao/MSN-TCSeg_dataset/1-10-new-draw/new_label' # 结果路径
