...
if __name__ == "__main__":
    # --- 请修改为你的实际路径 ---
    image_folder = '/data2/gaojiahao/MSN-TCSeg_dataset/split/2-images-before-tuomin/useful' # 原图文件夹路径
    mask_folder = '/data2/gaojiahao/MSN-TCSeg_dataset/split/3-masks-new/useful'  # 掩码文件夹路径
    output_folder = '/data2/gaojiahao/MSN-TCSeg_dataset/split/4-label/useful' # 结果路径
